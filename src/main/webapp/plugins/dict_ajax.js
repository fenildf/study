...
//http://dict.hjenglish.com/services/simpleExplain/en_simpleExplain.ashx?w=children
    ...
    HJ.fun = {
        ...
        jsonCallBack: function (json) {
            ...
            if (json && json.content) {
                ...
                if (D.get("hjd_uk_pronounce_sound")) {
                    ...
                    GetTTSFlash(hjd_uk_pronounce_sound, "mp3_flash", HJ.global.Domain + "/flash/speaker_mini_tts.swf", "son=http://tts.yeshj.com/uk/s/" + hjd_uk_pronounce_sound.innerHTML + "", 31, 16, false);
                }
                if (D.get("hjd_pronounce_sound")) {
                    GetFlash(D.get("hjd_pronounce_sound"), "Speaker_swf", HJ.global.Domain + "/flash/speaker.swf?v=4", D.get("hjd_pronounce_sound").innerHTML, 31, 16, false);
                }
                else if (D.get("hjd_fr_pronounce_sound")) {
                    var hjd_fr_pronounce_sound = D.get("hjd_fr_pronounce_sound");

                    GetTTSFlash(hjd_fr_pronounce_sound, "mp3_flash", HJ.global.Domain + "/flash/speaker_mini_tts.swf", "son=http://tts.yeshj.com/c/fr/s/" + hjd_fr_pronounce_sound.innerHTML + "", 31, 16, false);
                }
                else if (D.get("hjd_kr_pronounce_sound")) {
                    var hjd_kr_pronounce_sound = D.get("hjd_kr_pronounce_sound");
                    GetTTSFlash(hjd_kr_pronounce_sound, "mp3_flash", HJ.global.Domain + "/flash/speaker_mini_tts.swf", "son=http://tts.yeshj.com/c/kr/s/" + hjd_kr_pronounce_sound.innerHTML + "", 31, 16, false);
                }
                else {
        ...
        doSearch: function (e) {
            ...
            switch (language) {
                case "en":
                    if (G.mode == "simple"){
                    	jsonURL = jsonURL + "/services/simpleExplain/en_simpleExplain.ashx?w=";
                    } else{
                    	jsonURL = jsonURL + "/services/huaci/xml_web_ajax.ashx?w=";
                    }
                    break;
                case "jc":
                case "cj":
    ...
    function hjd_init() {
        ...
        try {
            ...
            objDynamic.href = HJ.global.Domain + "/outapp/huaci/styleAjax3.css?1015";
